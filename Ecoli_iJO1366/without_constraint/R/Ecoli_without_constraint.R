...
for(j in 1:length(fluxPercent)){
    ...
    #   If Epls [i, j] == true, then the deletion of gene i has reduced production of the metabolite j
    Epls <-run_pl(RNX_id,Ebio[[1]],Emodel,fluxPercent[1],seq(1:length(allGenes(Ecoli))),fdWT)
