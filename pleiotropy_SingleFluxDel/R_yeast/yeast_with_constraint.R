...
#------------------------------------------------------------------------------#
#simulated mutations of different severity by restricting the flux
#to a fixed fraction of the wildtype flux,
...
for(j in 1:length(fluxPercent)){
    ...
    Epl<- run_pl(RNX_id,Ebio[[1]],fluxPercent[1],RXNWT1)
